...
class TestReviewModel(unittest.TestCase):
    ...
    def test_place_id(self):
        ...
        self.review_model.place_id = "place_123"
        self.assertEqual(self.review_model.place_id, "place_123")

    def test_user_id(self):
        self.assertIsInstance(self.review_model.user_id, str)
        self.assertEqual(self.review_model.user_id, "")
        self.review_model.user_id = "user_123"
        self.assertEqual(self.review_model.user_id, "user_123")

    def test_text(self):
        self.assertIsInstance(self.review_model.text, str)
        self.assertEqual(self.review_model.text, "")
        self.review_model.text = "Great place to stay!"
        self.assertEqual(self.review_model.text, "Great place to stay!")
